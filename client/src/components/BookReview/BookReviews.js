...
const BookReviews = ({ initialReviews = [] }) => {
    ...
    return (<div className="book-reviews">
      ...
      <form onSubmit={handleSubmit} className="review-form">
        <input type="text" placeholder="Book Title" value={newReview.title} onChange={(e) => setNewReview({ ...newReview, title: e.target.value })} required/>
        <input type="text" placeholder="Author" value={newReview.author} onChange={(e) => setNewReview({ ...newReview, author: e.target.value })} required/>
